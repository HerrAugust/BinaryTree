...
public class Visualizzatore extends JPanel{
	...
	public Visualizzatore(String nome, Dimension dim, Point pos, BinaryTree<Integer> alberobinario) 
	{
		bt = alberobinario;
		if(bt.isEmpty()) {
	...
	private void showSottoalbero(Graphics g, BinaryTree<Integer> sottoalberodadisegnare, Point coordPadre, Point coordNonno) {
		...
		if(sottoalberodadisegnare.getRoot().isRoot()) { //coordNonno == null && coordPadre == null
